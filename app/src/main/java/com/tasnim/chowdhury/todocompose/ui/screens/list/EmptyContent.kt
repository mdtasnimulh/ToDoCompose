...
import com.tasnim.chowdhury.todocompose.ui.theme.MediumGray
...
fun EmptyContent() {
    Column(
        ...
        Icon(
            ...
            painter = painterResource(id = R.drawable.ic_empty_icon),
            contentDescription = stringResource(id = R.string.empty_list_icon),
            tint = MediumGray
        )
        Text(
